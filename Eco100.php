...
<html lang="en">
  <head>
    <?php echo $head;?>
    <title>คำนวนราคารุ่น ECO 100x20 | LiteWOOD</title>
  </head>
  <body>
  ...
  <div class="container-fluid">
    <a class="navbar-brand fw-bold" href="#">คำนวนราคารุ่น ECO 100x20</a>
  </div>
</nav>
    <br>
    <div class="container-fluid">
        ...
        <select id = "optioninstall" class="form-select mb-3" ></select>
